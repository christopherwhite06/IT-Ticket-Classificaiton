...
# You can widen this if you like, but it will cost more time
param_grid = {
    "C": [3.0]
}
...
grid = GridSearchCV(
    ...
    scoring="f1_weighted",
    n_jobs=-1,
    cv=3,          # lowered from 10 to make it practical
    verbose=3      # prints progress for each fold and parameter
)
